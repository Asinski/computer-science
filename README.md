...
+ Языки программирования:
    * Python:
        * [Инди-курс программирования на Python](https://stepik.org/course/63085/syllabus)
            ...
            - [Работа с файлами](https://docs-python.ru/tutorial/vstroennye-funktsii-interpretatora-python/funktsija-open/)
        ...
        * Библиотеки:
            ...
            - [Модуль typing](https://docs.python.org/3/library/typing.html)
                | [Работа с typing, часть 1](https://www.youtube.com/watch?v=cULVFnQ-ujg)
                | [Работа с typing, часть 2](https://www.youtube.com/watch?v=aaRfAkgPSms)
            ...
            - [Модуль marshmallow](https://marshmallow.readthedocs.io/en/stable/)
            ...
            - [Модуль pyyaml](https://pyyaml.org/wiki/PyYAMLDocumentation)
                | [Работа с pyyaml](https://tproger.ru/translations/yaml-za-5-minut-sintaksis-i-osnovnye-vozmozhnosti/)
            ...
            - [Документация по requests](https://docs.python-requests.org/en/latest/index.html)
                | [Работа с requests](https://python-scripts.com/requests#message-body)
            - [Документация по bs4](https://beautiful-soup-4.readthedocs.io/en/latest/)
                | [Работа с bs4](https://docs-python.ru/packages/paket-beautifulsoup4-python/)
...
+ Математика:
    ...
    * [Логико-математические задачи, часть 1](https://tproger.ru/articles/5-logiko-matematicheskih-zadach-kotorye-postavjat-v-tupik/)
    | [Логико-математические задачи, часть 2](https://tproger.ru/articles/10-logicheskih-zadach-s-sobesedovanij-kotorye-zastavjat-zastrelitsja/)
